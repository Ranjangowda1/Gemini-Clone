  ...
  return (
    ...
    <div className="main-container">
        ...
        <div className="cards">
            ...
            <div className="card">
                <p>Brefily summarize a long article</p>
            ...
            <div className="result-data">
                ...
                :
                <p dangerouslySetInnerHTML={{__html:resultData}}></p> /*to hide the tags in the result we use dangerously */
                }
